...
public class YarnResourceManagerDriver extends AbstractResourceManagerDriver<YarnWorkerNode> {
    ...
    protected void initializeInternal() throws Exception {
        ...
        try {
            // TODO flink内部在申请资源也是需要通过yarn的master来申请container,flink在进行资源的分配
            //   这里创建的是yarn的sourceManager的client   即 yarn的master
            ...
            // 如果程序恢复或者失败后,会尝试获取之前申请的container 如果是第一次启动,则是没有的
        ...
        // 创建yarn的nodeManager 因为在yarn中nodeManager是实际提供资源的
        nodeManagerClient =
