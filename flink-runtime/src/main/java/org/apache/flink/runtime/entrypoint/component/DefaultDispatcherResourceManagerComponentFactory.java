...
public class DefaultDispatcherResourceManagerComponentFactory
    ...
    public DispatcherResourceManagerComponent create(
        ...
        try {
            ...
            // 创建和启动dispatcher (检查的相关的)  ---> 会创建和启动JobMaster
            dispatcherRunner =
            ...
            // TODO 启动resourceManager  --> 里面是一些启动相关的内容,
            //  可以直接看ResourceManager中的onStart方法,是resourceManager.start后进行调用的onStart
