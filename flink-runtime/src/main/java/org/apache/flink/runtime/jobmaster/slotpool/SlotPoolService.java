...
public interface SlotPoolService extends AutoCloseable {
    ...
    /**
     * Offers multiple slots to the {@link SlotPoolService}. The slot offerings can be individually accepted or rejected by returning the collection of accepted slot offers.
     *
